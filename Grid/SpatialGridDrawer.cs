        ...
        private void DrawGrid()
        {
            ...
            if (showExistingCells)
            {
                ...
                foreach (var cell in grid.Cells)
                {
                    ...
                    {
                        SpatialAxis.XZ => new Vector3(cell.Coordinates.x + halfCellSize, gridPos.y, cell.Coordinates.y + halfCellSize),
                        SpatialAxis.XY => new Vector3(cell.Coordinates.x + halfCellSize, cell.Coordinates.y + halfCellSize, gridPos.z),
                        SpatialAxis.YZ => new Vector3(gridPos.x, cell.Coordinates.x + halfCellSize, cell.Coordinates.y + halfCellSize),
